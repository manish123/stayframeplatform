      ...
      <DialogContent className="max-w-6xl max-h-[90vh] p-0 flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription className="mt-1 text-muted-foreground">
            Select a template to start creating your reel
          </DialogDescription>
          <DialogClose asChild>
            <Button
              variant="ghost"
        ...
        <div className="flex-1 overflow-auto p-6">
          {templates.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-64">
              ...
              <p className="text-muted-foreground">No reel templates available.</p>
                    ...
                    {template.previewImageUrl ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          target.src = 'https://placehold.co/300x533/F7FAFC/1A202C?text=Preview+Not+Available';
                        }}
                      />
                    ) : (
